...
6. Обработка запросов к LLM
    ...
    - Для каждого вопроса:
        ...
        ![часть скрипта](https://github.com/Olysechka02/Portfolio/blob/main/Материалы/ближдок.png)
        4. Создание промта;
        5. Отправка в модель;
...
# Результат
    - Готовый скрипт, генерирующий точные ответы с использованием LLM и RAG
